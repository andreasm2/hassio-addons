...
- **noah-mqtt**: more information [https://github.com/andreasm2/noah-mqtt](https://github.com/andreasm2/noah-mqtt)
...
### Install noah-mqtt
1. Go back to the **Add-on store**, click **⋮ → Repositories**, fill in</br>  `https://github.com/andreasm2/hassio-addons` and click **Add → Close** or click the **Add repository** button below, click **Add → Close** (You might need to enter the **internal IP address** of your Home Assistant instance first).  
